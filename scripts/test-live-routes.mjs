const testUrls = [
  ...
  { url: 'http://localhost:3000/aile-ici-iletisim-sorunlari/', expected: 'Aile İçi İletişim' },
  ...
  { url: 'http://localhost:3000/blog/', expected: 'Psikoloji ve İlişki' },
  { url: 'http://localhost:3000/1034-beyoglu-yas-terapisi-kayip-destek/', expected: 'Yas' },
  { url: 'http://localhost:3000/979-taksim-cihangir-psikolog/', expected: 'Taksim' },
  { url: 'http://localhost:3000/stres-yonetimi/', expected: 'Stres' },
  { url: 'http://localhost:3000/sema-terapi/', expected: 'Şema' },
  { url: 'http://localhost:3000/bilissel-davranisci-terapi/', expected: 'BDT' },
